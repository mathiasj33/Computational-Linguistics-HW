...
from keras.layers import Embedding, GlobalMaxPooling1D, Dense, Convolution1D, Dropout, Merge
...
def main(argv):
    ...
    for kernel_size in (3, 4, 5):
        ...
        submodel.add(Convolution1D(filters=100, activation='relu', kernel_size=kernel_size))
